...
export default async function AdminLocatiiPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[720px] px-4 py-7 pb-16 sm:px-7 sm:py-8">
      ...
      <h2 className="mt-2 text-xl font-semibold sm:text-2xl">Adaugă o locație nouă</h2>
      <LocatieForm />
    </div>
  );
}
